...
const members: Omit<MemberProfile, "catData">[] = [
  ...
  },
  {
    ...
    title: "PRプランナー",
    comment:
      "保護猫を迎えてから、“ゆかいな生物多様性”をモットーに活動しています",
    catFile: "sawai.json",
  },
  {
    nameJa: "関陽子",
  ...
  },
  {
    ...
    nameEn: "Mio Takase",
    title: "アートディレクター",
    comment: "うちの猫が時折見せる、人間っぽい行動の謎に迫りたい！",
    catFile: "takase.json",
  },
  {
    nameJa: "なかのかな",
    nameEn: "Kana Nakano",
    title: "クリエイティブ・テクノロジスト／リサーチャー",
    comment:
      "necomimiという製品企画に関わったことがあり、猫に恩返しがしたいです",
    catFile: "nakano.json",
  },
  {
    nameJa: "中村恵",
  ...
  {
    nameJa: "中山桃歌",
    nameEn: "Momoka Nakayama",
    title: "クリエイティブ・テクノロジスト",
    comment: "感動的ですらある猫の身体感覚を、自分自身に宿らせたい！",
    catFile: "nakayama.json",
  },
  {
    nameJa: "根岸桃子",
  ...
  },
  {
    nameJa: "野田千尋",
    nameEn: "Chihiro Noda",
    title: "マーケティング・コンサルタント／リサーチャー",
    comment:
      "どう見てもペルシャにしか見えないラガマフィンの保護猫を毎日溺愛しながら暮らしています",
    catFile: "noda.json",
  },
  {
    nameJa: "若園祐作",
...
// Session cache: same MemberProfile object identities returned across
// in-session navigations, so fur cache (keyed by catData identity) hits.
let profilesPromise: Promise<MemberProfile[]> | null = null;

export function loadMemberProfiles(): Promise<MemberProfile[]> {
